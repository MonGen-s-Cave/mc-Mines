...
public class LoggerUtils {
    private final Logger logger = LogManager.getLogger("McMines");
    ...
    public void printStartup() {
        ...
        String reset = "\u001B[0m";
        String software = McMines.getInstance().getServer().getName();
        String version = McMines.getInstance().getServer().getVersion();
